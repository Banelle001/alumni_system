...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO Users (photo, name, surname, email,degree,graduation_year,student_number, password_hash, role_id, terms_accepted) VALUES (?, ?,? ,?,?,?, ?, ?, ?, ?)");
    $roleId = ($category == '1') ? 1 : 2; // 1 for Alumni, 2 for Staff
    $stmt->bind_param("sssssssssi", $photo, $name, $surname, $email, $degree,$graduation_year, $student_number, $passwordHash, $roleId, $termsAccepted);
