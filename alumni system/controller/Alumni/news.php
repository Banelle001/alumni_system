<?php
 ...
 if ($result === false) {
     ...
     echo '<div class="News-box" style="background-color:#1e5785">';
     echo '<h3>' . $first_row['title'] . '</h3>';
     echo '<p>' . $first_row['content'] . '</p>';
     echo '<div class="text-center">';
     echo '<a href="../controller/Alumni/login.php" class="more-btn"><span>Read More</span> <i class="bi bi-chevron-right"></i></a>';
     echo '</div>';
     echo '</div>';
     echo '</div>';
